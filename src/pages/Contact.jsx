...
export default function Contact() {
  ...
  return (
    <>
      ...
      <TopBar />
      <img src="/logo-mark.png" alt={t("contact.seo.logoAlt")} width={448} height={434} style={{ display: "none" }} />
          ...
          <form ref={reveal} onSubmit={onSubmit} style={{ ...r0, transitionDelay: ".1s" }}>
            ...
            {status === "sent" && (
              <div style={{
                ...
                {/* Poussière dorée — confinée à la colonne de l'avatar,
                    jamais sur le texte */}
                <div style={{ position: "absolute", inset: "-40px auto auto 0", width: "26%", height: 460, overflow: "hidden", pointerEvents: "none" }}>
